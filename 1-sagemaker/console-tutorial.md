...
9.  Go to the *App Specification* field. Then add `python3` as the first entrypoint and the local address to your Python script, for example `/opt/ml/processing/input/code/<your_script_name>`, as the second. If you use the provided script, you need to add the name of the dataset as a container argument.
<center><img src="img/app_specs.png"></center>
...
<center><img src="img/processing_output.png"></center>
